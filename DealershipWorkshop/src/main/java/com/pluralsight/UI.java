...
public class UI {
    ...
    private void processAddVehicle() {
        ...
        try {
            ...
            this.fileManager.saveDealership(this.dealership);
    ...
    private void processRemoveVehicle() {
        ...
        try {
            ...
            if (vehicleToBeRemoved != null) {
                this.dealership.removeVehicle(vehicleToBeRemoved);
                this.fileManager.saveDealership(this.dealership);
                System.out.println("Vehicle with VIN: " + vinToRemove + ", removes successfully!");
            } else {
